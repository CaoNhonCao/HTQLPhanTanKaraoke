...
namespace HTQLKaraoke.QLSP_Kho
{
    public partial class frmThemSanPham : Form
    {
        ...
        {
            // Tạo mã sản phẩm ngẫu nhiên 10 ký tự
            ...
            cbxLoaiSanPham.Items.AddRange(new string[] { "Bia", "Rượu", "Nước ngọt", "Nước suối", "Đồ ăn nhẹ", "Trái cây", "Combo" });
            cbxDonViTinh.Items.AddRange(new string[] { "Lon", "Chai", "Bịch", "Một", "Dĩa", "Kết" });
            cbxLoaiSanPham.DropDownStyle = ComboBoxStyle.DropDownList;
            cbxDonViTinh.DropDownStyle = ComboBoxStyle.DropDownList;
        }
