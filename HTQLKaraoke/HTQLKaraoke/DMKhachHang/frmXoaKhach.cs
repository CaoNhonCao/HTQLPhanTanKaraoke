...
namespace HTQLKaraoke.DMKhachHang
{
    public partial class frmXoaKhach : Form
    {
        ...
        {
            // Lấy mã khách hàng từ giao diện
            string maKhachHang = customerId;
            ...
            try
            {
                ...
                AND TinhTrang = 'Chưa thanh toán'";
                    ...
                    string[] tables = { "HoaDon", "DanhGiaKhachHang", "DatPhong", "Khuyenmai" };
                    ...
                    PerformDeleteCustomer(maKhachHang);
                }
            }
            catch (Exception ex)
            {
                ...
                using (SqlConnection conn = new SqlConnection(connection))
                {
                    ...
                    using (SqlTransaction transaction = conn.BeginTransaction())
                    {
                        try
                        {
                            ...
                            {
                                "DELETE FROM KhuyenMai WHERE MaKhachHang = @MaKhachHang",
                                "DELETE FROM DanhGiaKhachHang WHERE MaKhachHang = @MaKhachHang",
                                "DELETE FROM HoaDon WHERE MaKhachHang = @MaKhachHang",
                                "DELETE FROM DatPhong WHERE MaKhachHang = @MaKhachHang"
                            };
