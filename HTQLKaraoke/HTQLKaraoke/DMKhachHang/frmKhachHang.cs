...
namespace HTQLKaraoke.TrangChu
{
    public partial class frmKhachHang : Form
    {
        ...
        public frmKhachHang()
        {
            ...
            toolTipBtn.SetToolTip(this.txtTimKiem, "Nhập vào họ tên hoặc số điện thoại hoặc email để tìm kiếm");
        }
        ...
        private void LoadKhachHang()
        {
            ...
            dtgKhachHang.AllowUserToAddRows = false;
        ...
        {
            frmThemKhach formThemKhach = new frmThemKhach();
        ...
        private void dtgKhachHang_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                var maKhachHang = selectedRow.Cells["MaKhachHang"];
                
                if (maKhachHang.Value != null)
                {
                    customerId = maKhachHang.Value.ToString();
                    txtMaKhach.Text = customerId;
                    txtHoTen.Text = selectedRow.Cells["HoTen"].Value.ToString();
                    txtDiaChi.Text = selectedRow.Cells["DiaChi"].Value.ToString();
                    txtLoaiKhach.Text = selectedRow.Cells["LoaiKhachHang"].Value.ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            frmSuaTTKhach frmSuaKhach = new frmSuaTTKhach(customerId);
