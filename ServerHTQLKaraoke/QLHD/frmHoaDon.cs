    ...
    public partial class frmHoaDon : Form
    {
        ...
        private void LoadHoaDon()
        {
            try
            {
                ...
                LEFT JOIN [dbo].[PhongHat] ph ON hd.MaPhong = ph.MaPhong
                ORDER BY hd.NgayLapHoaDon DESC"; // Optional: Order by date
                    ...
                    dataGridViewHoaDon.Columns["SoPhong"].HeaderText = "Số Phòng";
                    dataGridViewHoaDon.Columns["LoaiPhong"].HeaderText = "Loại Phòng";
